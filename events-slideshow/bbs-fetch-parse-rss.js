      ...
      .each(function() {
        ...
        const template = `
          <div class="item">
            ...
            <div class="image-container" style="background-image: url('${el.find("media\\:content").attr("url")}'); background-size: cover;"><img class="title-image" src='${el.find("media\\:content").attr("url")}' alt=""></div>
